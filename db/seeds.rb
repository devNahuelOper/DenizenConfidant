...
# berghain.photo.attach(io: open('https://denizen-confidant-seeds.s3.amazonaws.com/news/berghain.png'), filename: 'berghain.png')

# caprices = News.create({title: 'Coronavirus latest: Caprices Festival confirms 2020 lineup', blurb: 'Everything we know about how COVID-19 (the disease caused by the novel coronavirus) is affecting the electronic music scene.', category: 'Music News', author: 'Resident Advisor', body: 'Here\’s a summary of the global impact of the novel coronavirus pandemic, officially specified as COVID-19, on festivals, clubs, promoters and the electronic music scene at large. ~ August 24th ~ Swiss festival Caprices has confirmed the lineups for its two-weekend event in September, with the likes of Ricardo Villalobos, Sonja Moonear and Mathew Jonson heading to Crans-Montana. Capacity is limited to 1000 people per stage. ~ August 21st ~ Earlier this week, Italian and Spanish officials ordered all clubs, venues and party spaces to close as cases of COVID-19 are on the rise again in both countries. In Italy, new cases this past week were more than double those of three weeks ago, while the median age of the people infected has dropped below 40. Vietnam\'s EPIZODE festival has announced more artists for its next edition running December 29th, 2020, though January 10th, 2021. ~ August 4th ~ The BPM Festival has cancelled it first edition in Malta, originally planned for mid-September, due to an increase in COVID-19 cases in Malta. Escape 2 The Island, Rhythm + Waves and Mi Casa Festival were also affected by the Maltese Tourism Authority\'s decision. ~ July 30th ~ The "Save Our Stages Act" has been introduced in the US Senate, Rolling Stone reports. It would provide a grant of either 45 percent of operating costs up to $12 million for six months, and would "ensure that relief funds only go to small, independent venue operators, promoters and talent reps." It also opens the door to future, related grants after the initial six-month period. ~ July29th ~ LA talent giant Creative Artists Agency (CAA) laying off 90 employees and furloughing 275, largely in the music and sports division, Deadline reports. CAA\'s electronic music roster includes a wide-range of artists from the likes of Kraftwerk, Daft Punk and Kylie Minogue. The agency has also represented the likes of Henry Wu for touring outside North America. In April, the agency made pay cuts due to the pandemic. ~ Serbia\'s EXIT Festival has been postponed again as the country\'s COVID-19 situation becomes less stable. The festival moved from July to late August after the government requested it take place this season, and then earlier in July, capacity was cut to 90 percent as the number of reported coronavirus cases began to rise. Now, the next edition will take place in 2021 and EXIT\'s already named the first acts on the lineup.'})
# caprices.photo.attach(io: open('https://denizen-confidant-seeds.s3.amazonaws.com/news/caprices.png'), filename: 'caprices.png')


london = News.create({title: 'London\'s Low Company shop to close its doors, physically and digitally', blurb: '"Whoever dreamed of running a webshop?"', category: 'World News', author: 'Andrew Ryce', body: 'Low Company in London is officially closing this Friday, August 21st. ~ In a long and personal newsletter, Low Company founder Kiran Sande explained the decision, saying that the COVID-19 pandemic only accelerated the closure, which he originally planned for spring 2021. He had mulled moving down the road in Hackney Downs for a new location that would require an eight-year lease, but decided that ending the shop was the best course of action. ~ Sande says that the end of the shop is both physical and online—"Whoever dreamed of running a webshop," he asks. He says that the store was meant as "a place in London I could call my own to sit and hold court and drink and have a good moan," and mentions that the store could not exist without his coworkers Sanjay, Kenny and Estelle. ~ The Low Company label will continue in earnest, with distribution in place for the web of affiliate labels who have new releases planned. ~ The final day of the shop will be this Friday, August 21st, with customer pickup (via handouts through a window) available for the week after. The shop will become inaccessible starting on September 7th. ~ Before starting Low Company, Sande was known for running the revered Blackest Ever Black label. That shut down last year.'})
london.photo.attach(io: open('https://denizen-confidant-seeds.s3.amazonaws.com/news/london.png'), filename: 'london.png')

frankie = News.create({title: 'Posthumous Frankie Knuckles track is the first taste of DJ International\'s new Jackmaster 7 compilation', blurb: 'The new collection is a follow-up to the Chicago label\'s six legendary Jackmaster albums from the late \'80s.', category: 'Music News', author: 'Andrew Ryce', body: '"Carefree (I Am A Star)" features production and vocals from the late Chicago house legend. It\'s the first single from a new project called Jackmaster 7, a follow-up to the foundational house music compilation series Jackmaster, which DJ International released six volumes of from 1987 through 1991. ~ The new Frankie Knuckles single comes with two remixes: one by label head Rocky Jones and the other by Chicago\'s Chip E.. ~ More singles from Jackmaster 7 will be released in the coming weeks, each featuring a new original backed with remixes. ~ DJ International, founded in 1985, is one of the most important house music labels alongside imprints like Trax, Alleviated and Jack Trax. It has released music from Marshall Jefferson, Farley "Jackmaster" Funk, Larry Heard, Tyree Cooper, Steve "Silk" Hurley and many more. ~ Frankie Knuckles, meanwhile, is one of the most legendary figures in house music, known as one of the originators of the form. You can read more about his life in our 2014 feature.'})
frankie.photo.attach(io: open('https://denizen-confidant-seeds.s3.amazonaws.com/news/frankie.png'), filename: 'frankie.png')

# News.create({title: '', blurb: '', category: '', author: '', body: ''})
# News.create({title: '', blurb: '', category: '', author: '', body: ''})