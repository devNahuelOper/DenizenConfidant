                ...
                <ul>
                  {currentUser.events.map((event, i) => (
                    <li key={i} id={event.id || null}>
                      <h1 id="myevent-date">
                        {formatMonthYear(event.created_at)}
                      </h1>
                      <article className="user-event">
                        <span className="myevent-details">
                          <small>
                            {formatDateStyle(event.date)
                              .split(" ")
                              .slice(0, 2)
                              .join(" ")}{" "}
                            /{" "}
                          ...
                          <br />
                          <small>at </small> <strong>{event.venue}</strong>,{" "}
                      ...
                      <div className="confirm" id={`confirm-${event.id}`}>
                        ...
                        <span>
                          <button
                            ...
                            onMouseUp={() => deleteEvent(event.id)}
                          >
                            Yes
                          </button>
                          <button onClick={() => this.confirm(event.id)}>
                            No
                          </button>
                        </span>
                      </div>
